...
from utils import get_logger, cvt2normal_state, assign_learning_rate, adjust_learning_rate, add_weight_decay
...
def main():
    ...
    cnn_params = list(model_fe.named_parameters()) + list(model_cls.named_parameters())
